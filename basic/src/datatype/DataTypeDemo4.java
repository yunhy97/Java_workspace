...
public class DataTypeDemo4 {
	...
	public static void main(String[] args) {
		...
		//논리값 리터럴  true     false
		//정수 리터럴    1   10   0  -3   1_000_000 10000000000000L  2010101010101010l
		...
		//각 리터럴별 변수 사용하기
		//논리값 다루기    ture 와  false는 참 / 거짓 논리값을 나타내는 자바의 예약어이다.
...
//		int num6 = 3000000000; 	  //int 값의 범위를 초과하기 때문에 오류 
		long num7 = 3000000000L;  //int 값의 범위를 초과하는 값을 long에 대입할 때 리터럴에 L을 붙인다.
		int num8 = 012;			  //8진수 12가 저장된다.
		int num9 = 0x12;		  //16진수 12가 저장된다.
		int num10 = 0xA4;		  //10=A 11=B ...
		...
		//실수값 다루기
		float value1 = 3.14f;      //실수리터럴은 double타입으로 판단한다. float타입으로 판단하도록f 를붙인다.
		double value2 = 3.14;
