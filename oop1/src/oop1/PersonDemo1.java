...
public class PersonDemo1 {
	...
	public static void main(String[] args) {
		...
		Person p1 = new Person();		//객체 생성, 생성된 객체의 주소값을 변수에 대입
		...
		p1.email = "kim@naver.com";
		p1.gender = "남자";
		p1.age = 50;
		
		p2.name = "이순신";
		p2.tel = "010-7856-8956";
		p2.email = "lee@naver.com";
		p2.gender = "남자";
		p2.age = 48;
		
		p3.name = "류관순";
		p3.tel = "010-4562-1234";
		p3.email = "ryu@hanmail.net";
		p3.gender = "여자";
		p3.age = 17;
