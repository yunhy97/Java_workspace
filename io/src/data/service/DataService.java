...
public class DataService {
	...
	public void printDataBySido(String sido) {
		...
		System.out.println("지역별 사고건수: " + datas.size());
		System.out.println("지역별 사망자수: " + totalDeath);
	}
	...
	public void printDataByDay(String day) {
		...
		System.out.println("날짜별 사고건수: " + datas.size());
		System.out.println("날짜별 사망자수: " + totalDeath);
	}
	
	//시도를 전달받아서 해당지역의 구군별 사고현황 통계를 출력하는 기능
	...
	public void printDataStatByMonth() {
		...
		for(Data data : datas) {
			String day = data.getDay();		//"01-01","01-12"...
	...
	public void printDataStatByDay() {
	...
	public void printDataStat() {
		//최다 사고발생 시도, 최다 사고발생 월, 최다 사고발생일,최다 발생요일, 최다 사고 발생 유형
		...
		Stat violatinMaxStat = maxStat(violationMap);
		...
		System.out.println("최다 사고 발생 유형 : " + violatinMaxStat.getName() + ", " + violatinMaxStat.getRecords() + ", " + violatinMaxStat.getDeaths());
