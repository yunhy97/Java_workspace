...
(
	...
	BOOK_REGISTERED date DEFAULT sysdate ,
...
(
	...
	CONSTRAINT SYS_C007026 PRIMARY KEY (ANSWER_NO)
);
...
(
	...
	CONSTRAINT SYS_C007023 PRIMARY KEY (QUESTION_NO)
);
...
ALTER TABLE HR.SAMPLE_BOOK_ANSWERS
	ADD CONSTRAINT SYS_C007027 FOREIGN KEY (QUESTION_NO)
...
ALTER TABLE HR.SAMPLE_BOOK_QUESTIONS
	ADD CONSTRAINT SYS_C007024 FOREIGN KEY (USER_ID)
	REFERENCES HR.SAMPLE_BOOK_USERS (USER_ID)
;
